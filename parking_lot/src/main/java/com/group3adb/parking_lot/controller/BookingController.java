...
import com.group3adb.parking_lot.exception.BookingExists;
...
import com.group3adb.parking_lot.service.impl.BookingServiceImpl;
import org.springframework.web.bind.annotation.CrossOrigin;
...
public class BookingController {
    ...
    @GetMapping("/bookings/{username}/{roles}")
    public ResponseEntity<List<Booking>> getBookingById(@PathVariable(value = "username") String username, @PathVariable(value = "roles") String roles)
